  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 disabled:text-neutral-300 border border-neutral-200 shadow-xs",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-white text-black border border-black/30 hover:border-black transition",
        ghost:
          "border-transparent shadow-none hover:bg-accent hover:text-accent-foreground",
        muted: "bg-black text-neutral-600",
        teritary:
      ...
      size: {
        ...
        xs: "rounded-md h-7 px-2 text-xs",
